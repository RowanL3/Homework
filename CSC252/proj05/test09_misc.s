...
PROGRAM:
                                      #lab1:
    .word 0x20120010                  #    addi $s2, $zero, 0x10
    .word 0x2013000a                 #    addi $s3, $zero, 0xA
    .word 0x02538822                  #    sub  $s1, $s2, $s3
    .word 0x0c00000e                  #    jal  lab2
    .word 0x08000012                  #    j    done
                                      #lab2:
    .word 0x22310001                  #    addi $s1, $s1, 1
    .word 0x12320002                  #    beq  $s1, $s2, lab3
    .word 0x0810000e                  #    j    lab2
                                      #lab3:
    .word 0x03e00008                  #    jr   $ra 
                                      #done:
    .word 0x0232602a                      #slt  $t4, $s1, $s2
